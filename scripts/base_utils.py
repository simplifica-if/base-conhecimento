...
PPCS_INDEX_PATH = PPCS_ROOT / "index.json"
PPCS_SECOES_PATH = PPCS_ROOT / "secoes.jsonl"
...
PROCESSOS_SELETIVOS_INDEX_PATH = INSTITUCIONAL_ROOT / "ifpr" / "processos-seletivos" / "index.json"
PROCESSOS_SELETIVOS_ROOT = INSTITUCIONAL_ROOT / "ifpr" / "processos-seletivos"
...
PROCESSOS_SELETIVOS_INDEX_SCHEMA_PATH = SCHEMAS_ROOT / "processos_seletivos_index.schema.json"
PROCESSO_SELETIVO_SCHEMA_PATH = SCHEMAS_ROOT / "processo_seletivo.schema.json"
...
PPCS_INDEX_SCHEMA_PATH = SCHEMAS_ROOT / "ppcs_index.schema.json"
